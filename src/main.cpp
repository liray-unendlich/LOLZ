...
const string strMessageMagic = "LoanOrLeaseZ Signed Message:\n";
...
{
    int64_t nSubsidy = 0;
    if(nBestHeight >= 10 && nBestHeight < 129600){
      nSubsidy = 7 * COIN;
    }else if(nBestHeight >= 129600 && nBestHeight < 259200){
      nSubsidy = 6 * COIN;
    }else if(nBestHeight >= 259200 && nBestHeight < 518400){
      nSubsidy = 5 * COIN;
    }else if(nBestHeight >= 10 && nBestHeight < 777600){
      nSubsidy = 4 * COIN;
    }else {
      nSubsidy = 3 * COIN;
    }
...
static int64_t nTargetTimespan = 6 * 60;  // 6 mins
...
{
    RenameThread("loanorleasez-loadblk");
...
{
    int64_t ret = blockValue * 3/5; //60% reward masternode
