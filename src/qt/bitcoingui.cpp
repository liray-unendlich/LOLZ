...
{
    resize(900, 520);
    setWindowTitle(tr("LoanOrLeaseZ") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("loanorleasez");
    setStyleSheet("#loanorleasez { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a LoanOrLeaseZ address"));
	...
	connect(investAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(investAction, SIGNAL(triggered()), this, SLOT(gotoinvestPage()));

    quitAction = new QAction(tr("E&xit"), this);
    quitAction->setToolTip(tr("Quit application"));
    quitAction->setShortcut(QKeySequence(Qt::CTRL + Qt::Key_Q));
    quitAction->setMenuRole(QAction::QuitRole);
	pioAction = new QAction(QIcon(":/icons/web"), tr("&LoanOrLeaseZ Website"), this);
	pioAction->setToolTip(tr("Visit the Official LoanOrLeaseZ website"));
	bitcointalkAction = new QAction(QIcon(":/icons/bitcointalk"), tr("&Bitcointalk Discussion"), this);
	bitcointalkAction->setToolTip(tr("Visit the Bitcointalk LoanOrLeaseZ discussion thread"));
	chainAction = new QAction(QIcon(":/icons/slack"), tr("&LoanOrLeaseZ Slack"), this);
	chainAction->setToolTip(tr("Join LoanOrLeaseZ Slack"));	
	explorerAction = new QAction(QIcon(":/icons/explorer"), tr("&LoanOrLeaseZ Explorer"), this);
	explorerAction->setToolTip(tr("LoanOrLeaseZ Explorer"));	
    aboutAction = new QAction(tr("&About LoanOrLeaseZ"), this);
    aboutAction->setToolTip(tr("Show information about LoanOrLeaseZ"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for LoanOrLeaseZ"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }" 
                           ...
                           "#tabs { color: #000000; background-color: #028fcc; border: none; padding-top: 0px; padding-bottom: 0px; }");
	...
	toolbar->addAction(investAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("LoanOrLeaseZ client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("LoanOrLeaseZ client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LoanOrLeaseZ network", "", count));
}
...
{
    QString strTitle = tr("LoanOrLeaseZ") + " - ";
...
void BitcoinGUI::gotoinvestPage()
{
  investAction->setChecked(true);
	...
	if ( investtimestamp > timestamp ) { 
	 ...
	 QDesktopServices::openUrl(QUrl("https://invest.loanorleasez.io"));
	 }
	}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid LoanOrLeaseZ address or malformed URI parameters."));
    }
...
{
    QDesktopServices::openUrl(QUrl("http://www.loanorleasez.io"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("http://bitcointalk.loanorleasez.io"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://loanorleasez.herokuapp.com"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://loanorleasez.info"));
}
