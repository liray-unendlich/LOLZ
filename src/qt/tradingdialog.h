...
private slots:
    ...
    QString BuyLOLZ(QString OrderType, double Quantity, double Rate);
    QString SellLOLZ(QString OrderType, double Quantity, double Rate);
