...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeloanorleasezAmount"))
        settings.setValue("nAnonymizeloanorleasezAmount", 1000);
    nAnonymizeloanorleasezAmount = settings.value("nAnonymizeloanorleasezAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeloanorleasezAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeloanorleasezAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeloanorleasezAmount:
            return QVariant(nAnonymizeloanorleasezAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeloanorleasezAmount:
            nAnonymizeloanorleasezAmount = value.toInt();
            settings.setValue("nAnonymizeloanorleasezAmount", nAnonymizeloanorleasezAmount);
            emit AnonymizeloanorleasezAmountChanged(nAnonymizeloanorleasezAmount);
            break;
        default:
            break;
        }
