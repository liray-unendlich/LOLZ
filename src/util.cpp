...
int nAnonymizeloanorleasezAmount = 1000;
...
#else
    const char* pszModule = "loanorleasez";
#endif
    if (pex)
        return strprintf(
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\LoanOrLeaseZ
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\LoanOrLeaseZ
    // Mac: ~/Library/Application Support/LoanOrLeaseZ
    // Unix: ~/.loanorleasez
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LoanOrLeaseZ";
#else
    fs::path pathRet;
...
void createConf()
{
	...
	const char* nodes =  "\nrpcport=19919"
						 ...
						 "\nserver=1"
						 "\nlistenonion=0"
					     "\naddnode=node1.loanorleasez.io"
						 "\naddnode=node2.loanorleasez.io"
						 "\naddnode=node3.loanorleasez.io"
						 "\naddnode=node4.loanorleasez.io"
						 "\naddnode=node5.loanorleasez.io"
						 "\naddnode=node6.loanorleasez.io"
						 "\naddnode=node7.loanorleasez.io"
						 "\naddnode=node8.loanorleasez.io"
						 "\naddnode=node9.loanorleasez.io"
						 "\naddnode=node10.loanorleasez.io";
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "loanorleasez.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "loanorleasezd.pid"));
